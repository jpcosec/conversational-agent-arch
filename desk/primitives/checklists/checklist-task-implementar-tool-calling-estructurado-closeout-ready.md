---
# checklist-xxx
id: checklist-task-implementar-tool-calling-estructurado-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-tool-calling-estructurado-ready-for-closeout
- condition-task-implementar-tool-calling-estructurado-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
