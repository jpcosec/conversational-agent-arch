---
# checklist-xxx
id: checklist-task-implementar-listener-asíncrono-del-perfilador-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-listener-asíncrono-del-perfilador-ready-for-closeout
- condition-task-implementar-listener-asíncrono-del-perfilador-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
