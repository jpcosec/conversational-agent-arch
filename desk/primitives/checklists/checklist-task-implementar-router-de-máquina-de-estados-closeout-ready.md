---
# checklist-xxx
id: checklist-task-implementar-router-de-máquina-de-estados-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-router-de-máquina-de-estados-ready-for-closeout
- condition-task-implementar-router-de-máquina-de-estados-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
