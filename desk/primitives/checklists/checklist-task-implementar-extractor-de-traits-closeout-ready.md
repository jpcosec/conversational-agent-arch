---
# checklist-xxx
id: checklist-task-implementar-extractor-de-traits-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-extractor-de-traits-ready-for-closeout
- condition-task-implementar-extractor-de-traits-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
