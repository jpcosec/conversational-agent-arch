---
# checklist-xxx
id: checklist-task-conectar-maquina-de-estados-al-orquestador-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-conectar-maquina-de-estados-al-orquestador-ready-for-closeout
- condition-task-conectar-maquina-de-estados-al-orquestador-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
