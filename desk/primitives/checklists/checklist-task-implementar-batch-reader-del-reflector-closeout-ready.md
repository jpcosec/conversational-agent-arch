---
# checklist-xxx
id: checklist-task-implementar-batch-reader-del-reflector-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-batch-reader-del-reflector-ready-for-closeout
- condition-task-implementar-batch-reader-del-reflector-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
