---
# checklist-xxx
id: checklist-task-implementar-conector-sldb-del-ontologizador-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-conector-sldb-del-ontologizador-ready-for-closeout
- condition-task-implementar-conector-sldb-del-ontologizador-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
