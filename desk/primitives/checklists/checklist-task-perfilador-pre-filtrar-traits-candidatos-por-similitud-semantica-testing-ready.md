---
# checklist-xxx
id: checklist-task-perfilador-pre-filtrar-traits-candidatos-por-similitud-semantica-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-perfilador-pre-filtrar-traits-candidatos-por-similitud-semantica-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
