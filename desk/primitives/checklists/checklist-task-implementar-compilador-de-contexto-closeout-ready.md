---
# checklist-xxx
id: checklist-task-implementar-compilador-de-contexto-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-compilador-de-contexto-ready-for-closeout
- condition-task-implementar-compilador-de-contexto-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
