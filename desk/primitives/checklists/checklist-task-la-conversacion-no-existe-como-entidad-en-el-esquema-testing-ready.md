---
# checklist-xxx
id: checklist-task-la-conversacion-no-existe-como-entidad-en-el-esquema-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-la-conversacion-no-existe-como-entidad-en-el-esquema-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
