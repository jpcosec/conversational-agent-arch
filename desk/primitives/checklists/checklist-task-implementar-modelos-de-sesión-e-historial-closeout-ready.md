---
# checklist-xxx
id: checklist-task-implementar-modelos-de-sesión-e-historial-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-modelos-de-sesión-e-historial-ready-for-closeout
- condition-task-implementar-modelos-de-sesión-e-historial-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
