---
# checklist-xxx
id: checklist-task-integracion-total-end-to-end-con-corrida-real-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-integracion-total-end-to-end-con-corrida-real-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
