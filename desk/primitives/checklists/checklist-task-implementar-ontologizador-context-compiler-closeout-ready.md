---
# checklist-xxx
id: checklist-task-implementar-ontologizador-context-compiler-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-ontologizador-context-compiler-ready-for-closeout
- condition-task-implementar-ontologizador-context-compiler-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
