---
# checklist-xxx
id: checklist-task-implementar-scrubber-de-pii-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-scrubber-de-pii-ready-for-closeout
- condition-task-implementar-scrubber-de-pii-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
