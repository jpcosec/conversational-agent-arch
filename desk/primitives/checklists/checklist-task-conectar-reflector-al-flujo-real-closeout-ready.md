---
# checklist-xxx
id: checklist-task-conectar-reflector-al-flujo-real-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-conectar-reflector-al-flujo-real-ready-for-closeout
- condition-task-conectar-reflector-al-flujo-real-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
