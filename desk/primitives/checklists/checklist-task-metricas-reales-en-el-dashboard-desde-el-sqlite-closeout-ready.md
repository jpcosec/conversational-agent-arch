---
# checklist-xxx
id: checklist-task-metricas-reales-en-el-dashboard-desde-el-sqlite-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-metricas-reales-en-el-dashboard-desde-el-sqlite-ready-for-closeout
- condition-task-metricas-reales-en-el-dashboard-desde-el-sqlite-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
