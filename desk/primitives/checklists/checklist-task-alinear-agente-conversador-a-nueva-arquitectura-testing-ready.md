---
# checklist-xxx
id: checklist-task-alinear-agente-conversador-a-nueva-arquitectura-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-alinear-agente-conversador-a-nueva-arquitectura-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
