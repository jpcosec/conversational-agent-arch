---
# checklist-xxx
id: checklist-task-reconciliar-atoms-de-arquitectura-con-el-batch-runtime-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-reconciliar-atoms-de-arquitectura-con-el-batch-runtime-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
