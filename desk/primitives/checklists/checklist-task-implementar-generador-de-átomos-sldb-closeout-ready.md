---
# checklist-xxx
id: checklist-task-implementar-generador-de-átomos-sldb-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-generador-de-átomos-sldb-ready-for-closeout
- condition-task-implementar-generador-de-átomos-sldb-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
