---
# checklist-xxx
id: checklist-task-scrub-completo-del-assistant-y-marca-veraz-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-scrub-completo-del-assistant-y-marca-veraz-ready-for-closeout
- condition-task-scrub-completo-del-assistant-y-marca-veraz-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
