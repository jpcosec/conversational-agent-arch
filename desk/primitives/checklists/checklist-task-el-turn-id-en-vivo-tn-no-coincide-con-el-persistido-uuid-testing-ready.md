---
# checklist-xxx
id: checklist-task-el-turn-id-en-vivo-tn-no-coincide-con-el-persistido-uuid-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-el-turn-id-en-vivo-tn-no-coincide-con-el-persistido-uuid-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
