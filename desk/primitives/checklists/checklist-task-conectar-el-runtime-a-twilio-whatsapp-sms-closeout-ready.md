---
# checklist-xxx
id: checklist-task-conectar-el-runtime-a-twilio-whatsapp-sms-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-conectar-el-runtime-a-twilio-whatsapp-sms-ready-for-closeout
- condition-task-conectar-el-runtime-a-twilio-whatsapp-sms-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
