---
# checklist-xxx
id: checklist-task-implementar-reflector-batch-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-reflector-batch-ready-for-closeout
- condition-task-implementar-reflector-batch-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
