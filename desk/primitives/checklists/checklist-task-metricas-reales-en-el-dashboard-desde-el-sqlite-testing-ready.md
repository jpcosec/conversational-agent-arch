---
# checklist-xxx
id: checklist-task-metricas-reales-en-el-dashboard-desde-el-sqlite-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-metricas-reales-en-el-dashboard-desde-el-sqlite-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
