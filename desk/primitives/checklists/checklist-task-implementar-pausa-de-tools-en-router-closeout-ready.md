---
# checklist-xxx
id: checklist-task-implementar-pausa-de-tools-en-router-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-pausa-de-tools-en-router-ready-for-closeout
- condition-task-implementar-pausa-de-tools-en-router-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
