---
# checklist-xxx
id: checklist-task-chat-nueva-conversacion-ficha-del-lead-y-stepper-del-flujo-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-chat-nueva-conversacion-ficha-del-lead-y-stepper-del-flujo-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
