---
# checklist-xxx
id: checklist-task-implementar-capa-relacional-sql-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-capa-relacional-sql-ready-for-closeout
- condition-task-implementar-capa-relacional-sql-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
