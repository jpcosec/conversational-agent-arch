---
# checklist-xxx
id: checklist-task-renombrar-kb-agent-ontologizador-a-kb-agent-knowledge-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-renombrar-kb-agent-ontologizador-a-kb-agent-knowledge-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
