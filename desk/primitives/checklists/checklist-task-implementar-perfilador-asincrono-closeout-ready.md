---
# checklist-xxx
id: checklist-task-implementar-perfilador-asincrono-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-perfilador-asincrono-ready-for-closeout
- condition-task-implementar-perfilador-asincrono-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
