---
# checklist-xxx
id: checklist-task-implementar-listener-asíncrono-del-perfilador-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-implementar-listener-asíncrono-del-perfilador-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
