---
# checklist-xxx
id: checklist-task-una-kb-sin-embeddings-falla-en-silencio-y-nadie-avisa-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-una-kb-sin-embeddings-falla-en-silencio-y-nadie-avisa-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
