---
# checklist-xxx
id: checklist-task-verificar-si-el-known-gap-donpeppe-saludo-unico-sigue-vigente-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-verificar-si-el-known-gap-donpeppe-saludo-unico-sigue-vigente-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
