...
```json
{"type": "object", "properties": {"hcp_id": {"type": "string", "description": "Identificador del médico"}, "fecha_recontacto": {"type": "string", "format": "date", "description": "Fecha solicitada por el médico"}, "franja_horaria": {"type": "string", "enum": ["manana", "tarde", "noche"], "description": "Franja preferida"}, "campania_id": {"type": "string", "description": "Campaña que se retomará"}, "nota_contexto": {"type": "string", "description": "Dónde quedó la conversación"}}, "required": ["hcp_id", "fecha_recontacto", "campania_id"]}
```